                        ...
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2 text-center">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $sqls = mysqli_query($con, "SELECT b.nama_bulan, a.bilangan_acak, aa.pendaftar FROM bulan b, acak2021_2022 a, pendaftar2022_2023 aa WHERE b.kd_bulan = a.kd_bulan AND b.kd_bulan = aa.kd_bulan") or die(mysqli_error($con));
                                    foreach ($sqls as $sql) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            ...
                                            <td>
                                                <?php
                                                $ranges = mysqli_query($con, "SELECT * FROM range2021_2022") or die(mysqli_error($con));
