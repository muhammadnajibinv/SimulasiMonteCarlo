<div class="page-content--bgf7">
    ...
    if (isset($_POST['simpan-interval'])) {
        ...
        mysqli_query($con, "DELETE FROM range2021_2022") or die(mysqli_error($con));
        ...
        for ($i = 1; $i <= $jumlah; $i++) {
            ...
            mysqli_query($con, "INSERT INTO range2021_2022 (pendaftar, awal, akhir) VALUES ('$pendaftar', '$awal', '$akhir')") or die(mysqli_error($con));
        }
