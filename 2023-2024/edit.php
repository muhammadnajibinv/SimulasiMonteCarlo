...
if (isset($_POST["kd_bulan"]) && !empty($_POST["kd_bulan"])) {
    ...
    if (empty($kd_bulan_err) && empty($pendaftar_err)) {
        ...
        $sql = "UPDATE pendaftar2023_2024 SET pendaftar=? WHERE kd_bulan=?";
    ...
    if (isset($_GET["kd_bulan"]) && !empty(trim($_GET["kd_bulan"]))) {
        ...
        $sql = "SELECT * FROM pendaftar2023_2024 WHERE kd_bulan = ?";
        if ($stmt = mysqli_prepare($link, $sql)) {
            // Bind variables to the prepared statement as parameters
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link">Prediksi 2023 - 2024</a></li>
