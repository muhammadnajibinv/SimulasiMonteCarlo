...
?>
    ...
    if (isset($_POST['proses'])) {
        ...
        mysqli_query($con, "DELETE FROM acak2023_2024") or die(mysqli_error($con));
        ...
        for ($i = 1; $i <= $jumlah; $i++) {
            ...
            mysqli_query($con, "INSERT INTO acak2023_2024 ( kd_bulan, bilangan_acak ) VALUES ('$kode_bulan', '$random_number')") or die(mysqli_error($con));
        }
