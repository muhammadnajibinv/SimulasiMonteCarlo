    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav">
                ...
                <li class=""><a class="nav-link js-scroll-trigger" href="#home"><i class="fas fa-home"></i><span class="bot-line"></span> Home</a></li>
                <li class=""><a class="nav-link js-scroll-trigger" href="#pengertian"><i class="fas fa-info"></i><span class="bot-info"></span> Monte Carlo</a></li>
                <li class=""><a class="nav-link js-scroll-trigger" href="#pembimbing"><i class="fas fa-user"></i><span class="bot-info"></span> Pembimbing</a></li>
                <li class=""><a class="nav-link js-scroll-trigger" href="../simulasi"><i class="fas fa-chevron-circle-right"></i><span class="bot-info"></span> Mulai Simulasi</a></li>
            </ul>
        </div>
    </nav>
